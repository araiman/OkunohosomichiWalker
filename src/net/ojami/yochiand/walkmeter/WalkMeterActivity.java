...
package net.ojami.yochiand.walkmeter;
 ...
 private class WalkMeterReceiver extends BroadcastReceiver {
    ...
    public void onClick(View v) {
        ...
        case R.id.button_stop:
                ...
                mSensorTextView.setText(getString(R.string.label_counter_first));
                mSensorTextView2.setText(getString(R.string.label_counter_first2));
                break;
        }
    }
}
